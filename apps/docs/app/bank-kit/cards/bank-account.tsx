...
import { Button, Heading } from "@sol-ui/components";
  ...
  return (
    <div className="max-w-sm h-fit my-5 mx-2 relative ">
      <div className="flex items-center justify-between mb-6">
        ...
        <Heading className="font-medium py-0">
          Bank Accounts
        </Heading>
      </div>
      ...
      <div className=" flex flex-col gap-1 text-center mt-4 ">
        <Button
          variant="inverse"
          className="cursor-pointer   flex items-center justify-center bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3  [&amp;_svg]:pointer-events-none [&amp;_svg]:shrink-0 [&amp;_svg:not([class*='size-'])]:size-4  gap-1.5 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 h-[31px] rounded-lg"
        >
