...
export const MoneyScanner = () => {
  return (
    <Card className="">
      ...
      <div className=" grid auto-rows-min items-start gap-1.5 rounded-t-[min(var(--radius-4xl),24px)] text-center">
        <Heading>Scan to pay digitally</Heading>
        <SubHeading className="text-balance px-5 pb-5">
